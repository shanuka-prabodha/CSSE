            ...
            <Card variant="outlined">
                ...
                <CardContent>
                    ...
                    <Typography style={{ float: "right" }}>
                        <Button variant="contained" style={{ margin: "5px" }} disabled={props.status == "Pending" ? false : false} onClick={e => { handleClickOpen("Approve") }} >Approve</Button>
                        <Button variant="contained" style={{ margin: "5px" }} disabled={props.status == "Pending" ? false : false} onClick={e => { handleClickOpen("Decline") }}>Decline</Button> 
                    </Typography>
